...
//                   <FaCartShopping />
//                   <div className='absolute -top-2 -right-1 text-white bg-red-500 h-4 w-4 rounded-full m-0 p-0 text-sm text-center '>0</div>
//               </div>
//               <div className='text-slate-600' onClick={handleShowMenu}>
//                   <div className='text-3xl cursor-pointer w-8 h-8 rounder-full overflow-hidden drop-shadow-md'>
//                   {userData.image ? <img alt="" src={userData.image} className='h-full w-full'/>  :  <FaRegUserCircle />}
    ...
    <header className="fixed shadow-md w-full h-16 px-2 md:px-4 z-50 bg-white">
      ...
      <div className="flex items-center h-full justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-7">
          <nav className="gap-4 md:gap-6 text-base md:text-lg hidden md:flex">
            <Link to={""}>Home</Link>
            <Link to={"menu/657b040986bdb5e22d461d47"}>menu</Link>
            <Link to={"about"}>About</Link>
            <Link to={"contact"}>Contact</Link>
          </nav>
          <div className="text-2xl text-slate-600 relative">
            ...
            {showMenu && (
              <div className="absolute right-2 bg-white py-2  shadow drop-shadow-md flex flex-col min-w-[120px] text-center">
                ...
                <nav className="text-base md:text-lg flex flex-col md:hidden">
                  ...
                  <Link
                    to={"menu/657b040986bdb5e22d461d47"}
                    className="px-2 py-1"
                  >
                    Menu
                  </Link>
